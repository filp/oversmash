...
export function scrapePlayerStats (options, html) {
  ...
  stats[normalizeKeyName(options, 'competitive_rank')] = extractCompetitiveRanks(options, p)
  stats[normalizeKeyName(options, 'endorsement_level')] = extractEndorsementLevel(options, p)
